...
public class ServletExportar extends HttpServlet {
    ...
    private void generReporteVentas(HttpServletRequest request, HttpServletResponse response) throws IOException, Excepciones {
    ...
    private void generarReporteDevoluciones(HttpServletRequest request, HttpServletResponse response) throws IOException, Excepciones {
        String fechaInicial = request.getParameter("fechaInicial");
        String fechaFinal = request.getParameter("fechaFinal");
    ...
    private void generarReporteGanancias(HttpServletRequest request, HttpServletResponse response) throws IOException, Excepciones {
        String fechaInicial = request.getParameter("fechaInicial");
        String fechaFinal = request.getParameter("fechaFinal");
    ...
    private void generarReporteUsuarioMasVentas(HttpServletRequest request, HttpServletResponse response) throws IOException, Excepciones {
        String fechaInicial = request.getParameter("fechaInicial");
        String fechaFinal = request.getParameter("fechaFinal");
    ...
    private void generarReporteUsuarioMasGanancias(HttpServletRequest request, HttpServletResponse response) throws IOException, Excepciones {
        String fechaInicial = request.getParameter("fechaInicial");
        String fechaFinal = request.getParameter("fechaFinal");
    ...
    private void generarReporteMuebleMasVendido(HttpServletRequest request, HttpServletResponse response) throws IOException, Excepciones {
        String fechaInicial = request.getParameter("fechaInicial");
        String fechaFinal = request.getParameter("fechaFinal");
    ...
    private void generarReporteMuebleMenosVendido(HttpServletRequest request, HttpServletResponse response) throws IOException, Excepciones {
        String fechaInicial = request.getParameter("fechaInicial");
        String fechaFinal = request.getParameter("fechaFinal");
